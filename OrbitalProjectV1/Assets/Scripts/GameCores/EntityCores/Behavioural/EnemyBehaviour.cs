...
{
    [RequireComponent(typeof(EnemyAudioComp))]
    public class EnemyBehaviour : ItemWithTextBehaviour
    {
        ...
        private EnemyAudioComp enemyAudioComp;
        #endregion
        ...
        protected override void Awake()
        {
            ...
            enemyAudioComp = GetComponent<EnemyAudioComp>();
        ...
        public virtual void Update()
        {
            ...
            if (rb != null)
            {
                ...
                {
                    enemyAudioComp.InstantiateFootstepAudio();
                }
...
*/
        ...
        #region Enemy Movement Behaviour
        ...
        */
        ...
        public virtual void AnimationBreak(ANIMATION_CODE code)
        {
            switch (code)
            {
                ...
                case ANIMATION_CODE.ATTACK_END:
                    UnlockMovement();
                    inAnimation = false;
                    enemyAudioComp.InstantiateDamageAudio();
                    stateMachine.ChangeState(StateMachine.STATE.IDLE, null);
        ...
        /**
         * lazy to remove this animation event from animations that previously used this so im keeping it here.
         */
        ...
        public override void TakeDamage(int damage)
        {
            ...
            enemyAudioComp.InstantiateHurtAudio();
            _healthBar.SetHealth(health);
